...
>(({ className, children, error, ...props }, ref) => (
  <div className="w-full">
    <SelectPrimitive.Trigger
      ref={ref}
      className={cn(
        "flex h-11 w-full items-center justify-between rounded-lg border border-gray-300 bg-white px-4 py-2.5 text-sm",
        "focus:outline-none focus:ring-2 focus:ring-[#04599c] focus:border-[#04599c]",
        "data-[placeholder]:text-gray-400 transition-colors duration-200",
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex w-full cursor-default select-none items-center rounded-lg py-2.5 pl-8 pr-4 text-sm text-gray-700",
      "focus:bg-[#04599c]/10 focus:text-[#04599c] outline-none",
      "data-[state=checked]:bg-[#04599c]/10 data-[state=checked]:text-[#04599c]",
